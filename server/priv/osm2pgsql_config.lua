-- Based off of <https://github.com/openstreetmap/osm2pgsql/blob/master/flex-config/generic.lua>, described as:
...
tables.points = osm2pgsql.define_node_table('points', {
    ...
    { column = 'geom', type = 'point', projection = PROJ },
    { column = 'changeset_id', type = 'bigint' },
})

tables.lines = osm2pgsql.define_way_table('lines', {
    { column = 'tags', type = 'hstore' },
    { column = 'geom', type = 'linestring', projection = PROJ },
})

tables.polygons = osm2pgsql.define_area_table('polygons', {
    { column = 'tags', type = 'hstore' },
    { column = 'geom', type = 'geometry', projection = PROJ },
...
tables.routes = osm2pgsql.define_relation_table('routes', {
    { column = 'tags', type = 'hstore' },
    { column = 'geom', type = 'multilinestring', projection = PROJ },
    { column = 'changeset_id', type = 'bigint' },
})
...
local delete_keys = {
    -- "mapper" keys NOTE: We keep these because I want to experiment with showing info on where the data came from when displayed
